...
import LONGCALL from '../assets/longcall.jpg';
...
function LongCall() {
    ...
    return (
        <div>
            <p style={{ fontSize: 15 }} orientation="center" plain>Buying a call option
                offers the right to buy the underlying stock at a predetermined price.
                Your profit potential is virtually limitless, as the stock's value can
                surge dramatically. However, your risk is limited to the premium paid
                for the call option. This strategy capitalizes on strong bullish
                trends.<br></br>
            </p>
            <img
                src={LONGCALL}
