...
import BEARCALL from '../assets/bearcall.png';
...
function BearCall() {
    ...
    return (
        <div>
            <p style={{ fontSize: 15 }} orientation="center" plain>This strategy involves selling
                a lower-strike call while simultaneously buying a higher-strike call. The goal is
                for the underlying stock's price to remain below the lower strike call, allowing
                you to keep the premium as profit. The risk is limited to the difference between
                the two strike prices minus the premium received.<br></br>
            </p>
            <img
                src={BEARCALL}
